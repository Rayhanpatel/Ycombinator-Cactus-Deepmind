...
class Config:
    ...
    ROKID_VAD_START_THRESHOLD: float = float(os.getenv("ROKID_VAD_START_THRESHOLD", os.getenv("VAD_SENSITIVITY", "0.6")))
    ROKID_VAD_END_THRESHOLD: float = float(
        os.getenv("ROKID_VAD_END_THRESHOLD", str(max(0.15, ROKID_VAD_START_THRESHOLD - 0.18)))
    )
    ROKID_VAD_MIN_SILENCE_MS: int = int(os.getenv("ROKID_VAD_MIN_SILENCE_MS", "220"))
    ROKID_VAD_MIN_SPEECH_MS: int = int(os.getenv("ROKID_VAD_MIN_SPEECH_MS", "180"))
    ROKID_VAD_SPEECH_PAD_MS: int = int(os.getenv("ROKID_VAD_SPEECH_PAD_MS", "96"))
    ROKID_AUDIO_GATE_DB_OFFSET: float = float(os.getenv("ROKID_AUDIO_GATE_DB_OFFSET", "7.0"))
    ROKID_AUDIO_END_GATE_DB_OFFSET: float = float(os.getenv("ROKID_AUDIO_END_GATE_DB_OFFSET", "4.0"))
    ROKID_AUDIO_GATE_MIN_DBFS: float = float(os.getenv("ROKID_AUDIO_GATE_MIN_DBFS", "-52.0"))
